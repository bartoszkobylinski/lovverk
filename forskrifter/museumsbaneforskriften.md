...
Søknad om tillatelse til å ta i bruk kjøretøy skal minst inneholde:navn på og kontaktopplysninger til kontaktperson,systembeskrivelse,oversikt over relevante standarder som kjøretøy er bygget etter, samt eventuelle avvik fra disse standardene ogsikkerhetsvurderingsrapport som bekrefter sikker integrering mellom kjøretøy og infrastruktur.
...
Den som skal utføre eller opplæres til å utføre arbeidsoppgaver som nevnt i [§ 36](forskrift/2014-12-10-1574/§36) skal gjennomgå en helseundersøkelse som minst skal omfatte:en generell undersøkelse,undersøkelser av sansefunksjoner (syn, hørsel, fargesans),en analyse av urin- eller blodprøve for eventuelt å avdekke diabetes og eventuelle andre forhold som måtte følge av den kliniske undersøkelsen, herunder bruk av narkotiske stoffer.
